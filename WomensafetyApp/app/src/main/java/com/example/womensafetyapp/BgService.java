        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                case 1:
                    ...
                    if (ActivityCompat.checkSelfPermission(BgService.this, Manifest.permission.READ_SMS) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(BgService.this, Manifest.permission.READ_PHONE_NUMBERS) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(BgService.this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    SmsManager smsManager=SmsManager.getDefault();
                     smsManager.sendTextMessage(target_ph_number, ph_number, "Please help me. I need help immediately. This is where i am now:"+str_address, null, null);

                 	//Toast.makeText(getApplicationContext(), "Source:"+ph_number+"Target:"+target_ph_number, Toast.LENGTH_SHORT).show();
